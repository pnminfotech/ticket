  ...
  <footer class="footer-z bg-white pb-3 pb-lg-0 shadow">
    <div class="container">
      <div class="row">
        ...
        <!-- /col -->
        <div class="col-lg-6">
          <div class="pt-3 menu float-lg-end">
          
            <?php if ( ! empty( $custom_pages ) ) {
              foreach ( $custom_pages as $custom_page ) { ?>
                <span class="d-block d-sm-inline-block mb-2 mb-sm-0">
                  <a href="<?php echo env_url( 'page/' . html_escape( $custom_page->slug ) ); ?>"><?php echo html_escape( $custom_page->name ); ?></a>
                </span>
            <?php } }?>
            ...
            <div class="dropdown d-inline ms-0 ms-sm-3">
